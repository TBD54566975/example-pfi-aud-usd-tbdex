...
export class InMemoryExchangesApi implements ExchangesApi {
  ...
  async getExchanges(opts?: { filter: GetExchangesFilter }): Promise<Exchange[]> {
    console.log('call for exchanges ' + opts)
  ...
  addMessage(message: Message): void {
    ...
    console.log('added message to exchange', message.exchangeId)
    console.log('  of kind', message.metadata.kind)
